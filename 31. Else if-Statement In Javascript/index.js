...
প্রফেশনাল কোডিংয়ে  সাধারণত এভাবে লিখা হয় এতে কোনো সংখ্যাই বাদ পড়ে না।
...
জাভাস্ক্রিপ্টে যখন কোনো null মানের আগে প্লাস (+) চিহ্ন বসানো হয়, তখন জাভাস্ক্রিপ্ট সেটিকে সংখ্যায় রূপান্তর করার চেষ্টা করে। আর null কে সংখ্যায় রূপান্তর করলে তার মান হয় 0।

let test = null;
console.log(+test); // আউটপুট: 0

৩. কন্ডিশন চেক (কেন "Good" দেখাচ্ছে?)
যেহেতু ক্যান্সেল করার কারণে  speed এখন 0 হয়ে গেছে, তাই জাভাস্ক্রিপ্ট if-else লজিকগুলো চেক করতে শুরু করে:
...
input === null: ইউজার যদি "Cancel" ক্লিক করে, কোডটি ভাঙবে না।

input.trim() === "": ইউজার যদি বক্সে কিছু না লিখে বা শুধু স্পেস দিয়ে "OK" দেয়, তবে তাকে সতর্ক করবে।

isNaN(Number(input)): ইউজার যদি সংখ্যা না লিখে কোনো টেক্সট (যেমন: "abc") লেখে, সেটিও ধরা পড়বে।

let marks = +input: সব চেক পার হওয়ার পর ডাটাটিকে সংখ্যায় রূপান্তর করে, যা সেরা পদ্ধতি।
